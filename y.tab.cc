...
{
       0,    55,    55,    59,    60,    63,    67,    71,    74,    78,
      79,    83,    90,    91,    95,   115,   127,   128,   129,   133,
     138,   142,   149,   156,   164,   173,   176
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NEWLINE", "GREATGREAT", "AMPERSAND", "GREATAMPERSAND",
  ...
  "iomodifier", "background", YY_NULLPTR
};
#endif
...
{
      19,    -3,    -6,    -6,     2,    18,    -6,    -6,    -5,    -6,
      -6,    -6,    -6,    -6,     8,    13,    20,    21,    24,    25,
...
{
      14,    15,    12,    16,    11,    17,    18,    19,    20,    14,
      15,    24,    16,    31,    17,    18,    25,    20,    -2,     1,
       1,     2,     2,    26,    27,     3,     3,    28,     2,    30,
      34,    29,    32,     0,    13,    36
};

static const yytype_int8 yycheck[] =
{
       5,     6,     0,     8,     7,    10,    11,    12,    13,     5,
       6,     3,     8,     9,    10,    11,     3,    13,     0,     1,
       1,     3,     3,     3,     3,     7,     7,     3,     3,     3,
       3,    19,    21,    -1,     5,     7
};
...
static const yytype_int8 yystos[] =
{
      ...
      23,     7,     0,    17,     5,     6,     8,    10,    11,    12,
      13,    24,    25,    21,     3,     3,     3,     3,     3,    20,
       3,     9,    25,    26,     3,    22,     7
};
...
#line 95 "shell.y"
   ...
   // printf("   Yacc: insert argument \"%s\"\n", $1->c_str());
    wildcard = false;
    char * p = (char*)"";
    expandWildcards(p, (char *)(yyvsp[0].cpp_string)->c_str());
    //sort here?
...
#line 115 "shell.y"
       {
    if(strcmp((yyvsp[0].cpp_string)->c_str(), "exit")==0 && isatty(0)){
      printf("BYEEE\n");
		  exit(1);
    }
